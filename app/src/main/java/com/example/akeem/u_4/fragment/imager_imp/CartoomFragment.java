...
import com.example.akeem.u_4.adpter.CartoomImagsAdapter;
 ...
 */
public class CartoomFragment extends BaseFragment {
    @Bind(R.id.recyclerView)
    RecyclerView mRecyclerView;
    @Bind(R.id.srl)
    SwipeRefreshLayout mSrl;
    private List<ImagersBean.ImgsBean> mDatas;
    private CartoomImagsAdapter mAdapter;

    @Override
    public LoadingPage.LoadingResult initData() {

//        Looper.prepare();
        String resultJsonString = ImagsProtocol.loadData("动漫", 1);
        Gson gson = new Gson();
    ...
    public View initView() {
        View view = UiUtils.inflate(R.layout.fragment_cartoom);
        ButterKnife.bind(this, view);
        StaggeredGridLayoutManager staggeredGridLayoutManager = new StaggeredGridLayoutManager(2,
                StaggeredGridLayoutManager.VERTICAL);
        mRecyclerView.setLayoutManager(staggeredGridLayoutManager);
        //设置adapter
        mAdapter = new CartoomImagsAdapter(mActivity, mDatas);
